...
! function(e, t) {
	"object" == typeof exports && "undefined" != typeof module ? t(exports, require("echarts")) : "function" == typeof define &&
		define.amd ? define(["exports", "echarts"], t) : t(e.dataTool = {}, e.echarts)
}(this, function(e, t) {
	"use strict";
	...
	function n(e, t) {
		return e ? r(u(e, "node"), function(e) {
			var r = {
				...
				o = l(e, "viz:color"),
				s = l(e, "attvalues");
			if (a && (r.symbolSize = parseFloat(i(a, "value"))), n && (r.x = parseFloat(i(n, "x")), r.y = parseFloat(i(n, "y"))),
				o && (r.itemStyle.normal.color = "rgb(" + [0 | i(o, "r"), 0 | i(o, "g"), 0 | i(o, "b")].join(",") + ")"), s) {
				var f = u(s, "attvalue");
				r.attributes = {};
	...
	function o(e) {
		return e ? r(u(e, "edge"), function(e) {
			var t = {
				...
				a = l(e, "viz:thickness"),
				n = l(e, "viz:color");
			return a && (r.width = parseFloat(a.getAttribute("value"))), n && (r.color = "rgb(" + [0 | i(n, "r"), 0 | i(n,
				"g"), 0 | i(n, "b")].join(",") + ")"), t
		}) : []
	}
	...
	var c = Array.prototype.map,
		p = (Object.freeze || Object)({
			parse: function(e) {
				var t;
				if (!(t = "string" == typeof e ? (new DOMParser).parseFromString(e, "text/xml") : e) || t.getElementsByTagName(
						"parsererror").length) return null;
				var r = l(t, "gexf");
				if (!r) return null;
	...
	t.dataTool && (t.dataTool.version = "1.0.0", t.dataTool.gexf = p, t.dataTool.prepareBoxplotData = d), e.version =
		"1.0.0", e.gexf = p, e.prepareBoxplotData = d
});
